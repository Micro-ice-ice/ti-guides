...
Гайд предполагает стандартную партию **Twilight Imperium IV + Prophecy of Kings + Thunder’s Edge** на 6 игроков. Английские названия компонентов сохранены, поскольку устоявшейся русской локализации дополнения пока нет.
...
2. До розыгрыша Visionaria (карты прорыва) договориться минимум с двумя игроками:
...
- Открыть Breakthrough (прорыв).
- До Visionaria (карта прорыва) согласовать Gravity Drive и Hyper Metabolism с конкретными игроками.
...
**Dark Energy Tap** даёт доступ к frontier tokens (жетоны пограничия) и полезное правило отступления. Если в партии мало фракций, планирующих исследовать пустые системы, нетронутые frontier tokens превращаются в отдельный экономический ресурс: товары, жетоны, карты действий, фрагменты реликвий и другие эффекты исследования.
...
Позицию Speaker можно продать, если другой игрок готов дорого заплатить. По умолчанию выгодно передать её себе или партнёру так, чтобы во втором раунде гарантировать нужную карту. Как правило цена продажи спикера равна 2 товарам, но можно договариваться на изучение нужной технологии через ваш прорыв.
...
Использовать Ikatena для части экспедиции «5 ресурсов» или «5 влияния» неудобно: одной домашней планеты недостаточно, а добавление ещё одной планеты часто приводит к перерасходу. Главная ценность Diplomacy — tech skip и повторное использование экономики 4/4. Поэтому целимся именно в тех.скип планету.
...
- **Warfare** — низкий приоритет как собственная карта, но её вторичная способность очень полезна для производства эсминцев под DET, дополнительного транспортника и пехоты. Хотя иногда можно взять, если сможем захватить весь слайс и другого выбора у нас нет.
- **Construction** — низкий приоритет. На Ikatena уже стоит космодок; домашний PDS полезен, но редко стоит отдельной стратегической карты. Берем только если сможешь выполнить с ней цель. На этой фракции там как правило не нужны строения, поэтому нам будет достаточно вторичной способности.
...
- Важное замечание - вам возможно нужно будет быть соседями, чтобы они смогли обмыть продукцию.
...
Еще одно важное замечание касательно получения прорыва: если вы взяли карту 2/3/5 и экспедеция на секретную цель все еще доступна, а ваша секретная цель сомнительная, то лучше потратить именно секретную цель, а не другие ресурсы. 
